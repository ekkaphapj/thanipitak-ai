...
test('stt html includes hold-to-talk mic button', () => {
  ...
  assert.match(js, /กำลังประมวลผลเสียง/);
  ...
  for (const asset of ['thanipitak-ai-voice-sprite-v2.png', 'voice-hello.mp3', 'voice-greeting-2.mp3', 'voice-how-to-use.mp3', 'voice-acknowledge.mp3', 'voice-answer-question.mp3', 'voice-not-clear.mp3', 'voice-not-understand-question.mp3', 'voice-finish-job.mp3']) {
